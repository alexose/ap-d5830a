...
layout="top";//[beside, stacked, top, bottom]
...
//	["W", "Rectangle",		[6.75, -5.25+(8-5.3)/2,0,0,0,"outside"],				[wall_t/2, 10.5, 5.3]			],//switch cutout
	...
	["W", "Cylinder",		[-12,-6,0,11,90,"inside"],				[wall_t, 3, 10]			],//Battery Charging Amber LED
	["W", "Cylinder",		[12,-6,0,11,90,"inside"],				[wall_t, 3, 10]			],//Battery Charged Green LED
	["E", "Cylinder",		[-5, -6,0,11,90,"inside"],				[wall_t, 3, 10]			],//Battery Warning Red LED
	["E", "Cylinder",		[5, -6,0,11,-90,"inside"],				[wall_t, 3, 10]			]//TxRx Red LED
...
difference() {
    ...
    translate([0, 25, 0]) cube([120,2,40], center=true);
    translate([0, 20, 0]) cube([120,2,40], center=true);
    translate([0, 15, 0]) cube([120,2,40], center=true);
    translate([0, 10, 0]) cube([120,2,40], center=true);
    translate([0, 5, 0]) cube([120,2,40], center=true);
    translate([0, 0, 0]) cube([120,2,40], center=true);
    translate([0, -5, 0]) cube([120,2,40], center=true);
    translate([0, -10, 0]) cube([120,2,40], center=true);
    translate([0, -15, 0]) cube([120,2,40], center=true);
    translate([0, -20, 0]) cube([120,2,40], center=true);
